...
If that socket is not available, Lawn will instead refuse any non-Lawn (e.g., agent signing) requests with a normal failure message, and when it becomes available, Lawn will use it automatically.
